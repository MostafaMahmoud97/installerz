...
Trait GeneralFileService{
    ...
    public function SaveAssetBundle($file,$path){
        $file_name = date('Y-m-d').time().'.'.$file->getClientOriginalName();
        Storage::disk('public')->put($path.'/'.$file_name,file_get_contents($file));
        return $file_name;
    }
    ...
    public function getFileType($file){
        ...
        if ($extintion == "jpg" || $extintion == "png" || $extintion == "jpeg"|| $extintion == "webp" || $extintion == "svg"){
            return "image";
